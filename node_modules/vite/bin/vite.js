#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('c:\\Users\\Secondary\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.486\\out\\buildHook\\index.js').default({tool: 'vite', checkSum: '20fedb73224e6cf75ef416UEtXTAIJBFFRAwJXA1FWVVEBVwAH', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///c:/Users/Secondary/.vscode/extensions/wallabyjs.console-ninja-1.0.486/out/buildHook/index.js').then(m => m.default.default({tool: 'vite', checkSum: '20fedb73224e6cf75ef416UEtXTAIJBFFRAwJXA1FWVVEBVwAH', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
...
function start() {
  try {
    ...
    setTimeout(() => {
      try {
        // eslint-disable-next-line n/no-unsupported-features/node-builtins -- it is supported in Node 22.12.0+ and only called if i